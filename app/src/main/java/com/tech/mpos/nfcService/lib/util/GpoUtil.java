package com.tech.mpos.nfcService.lib.util;

import android.util.Log;

import androidx.annotation.Nullable;

import com.tech.mpos.nfcService.lib.model.TlvObject;
                ...
                for (TlvObject tlvObject : tlvObjectArrayList) {
                    ...
                    // Transaction Date; 9A, 3 Byte(s)
                        ...
                        if (simpleDateFormat != null) {
                            ...
                            if (dateFormat != null) {
                                resultValue = com.tech.mpos.nfcService.lib.util.HexUtil.hexadecimalToBytes(dateFormat);
                            }
                        }
                    }
                    // - Transaction Date; 9A, 3 Byte(s)
